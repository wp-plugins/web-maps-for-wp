...
********************************************************************************/
	...
	jQuery('#agol_for_WP_add_map_agol_search_input').keypress(function(e) {
		if (e.which == '13') {
			...
			var loadingSpinner = '<div id="loader"><img class="loading_spinner" src="' + urlTemp + '/agolforwp/assets/ajax-loader.gif" alt="Loading Results" /></div>';
	...
	jQuery('#agol_for_WP_add_map_agol_search_button').click(function(){
		if ( jQuery('#agol_for_WP_add_map_agol_search_input').val() ) {
			var tempValue = jQuery('#agol_for_WP_add_map_agol_search_input').val();
			var loadingSpinner = '<div id="loader"><img class="loading_spinner" src="' + urlTemp + '/wppluginforagol_free/assets/ajax-loader.gif" alt="Loading Results" /></div>';
